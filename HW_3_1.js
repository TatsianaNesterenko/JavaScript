...
// console.log(JSON.stringify(users));//вывод всего массива

// Решение 1
console.log('#Решение 1#');

const userSearch = users.filter(key => (key.registrationDate === '09.10.2021' || key.registrationDate === '10.10.2021'));
console.log(userSearch);

//Решение 2
console.log('#Решение 2#');
const userSearch_1 = users.filter((key) => {
...
console.log('*********1*********');
 const i = userSearch_1.map(el => el.firstName);//выведем только имена
 console.log(i);

 console.log('*********2*********');
console.log(userSearch_1.slice(0, 3));

console.log('*********3*********');
console.log(userSearch_1);
